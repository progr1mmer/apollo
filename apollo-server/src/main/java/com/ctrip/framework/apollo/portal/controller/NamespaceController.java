...
import com.ctrip.framework.apollo.portal.service.PortalAppNamespaceService;
...
public class NamespaceController {
  ...
  private final PortalNamespaceService namespaceService;
  ...
  public NamespaceController(
      ...
      final PortalNamespaceService namespaceService,
  ...
  public ResponseEntity<Void> deleteAppNamespace(@PathVariable String appId, @PathVariable String namespaceName) {
    ...
    PortalAppNamespace appNamespace = appNamespaceService.deleteAppNamespace(appId, namespaceName);
  ...
  public AppNamespaceDTO findAppNamespace(@PathVariable String appId, @PathVariable String namespaceName) {
    PortalAppNamespace appNamespace = appNamespaceService.findByAppIdAndName(appId, namespaceName);
  ...
  public PortalAppNamespace createAppNamespace(@PathVariable String appId,
      @RequestParam(defaultValue = "true") boolean appendNamespacePrefix,
      @Valid @RequestBody PortalAppNamespace appNamespace) {
    ...
    PortalAppNamespace createdAppNamespace = appNamespaceService.createAppNamespaceInLocal(appNamespace, appendNamespacePrefix);
  ...
  private Set<String> findMissingNamespaceNames(String appId, String env, String clusterName) {
    ...
    List<PortalAppNamespace> portalDbAppNamespaces = appNamespaceService.findByAppId(appId);
    ...
    for (PortalAppNamespace appNamespace : portalDbAppNamespaces) {
