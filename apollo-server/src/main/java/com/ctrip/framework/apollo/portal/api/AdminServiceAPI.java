...
public class AdminServiceAPI {
  ...
  public static class AppAPI extends API {
    ...
    public AppDTO loadApp(Env env, String appId) {
      return restTemplate.get(env, "/admin/apps/{appId}", AppDTO.class, appId);
    }

    public AppDTO createApp(Env env, AppDTO app) {
      return restTemplate.post(env, "/admin/apps", app, AppDTO.class);
    }

    public void updateApp(Env env, AppDTO app) {
      restTemplate.put(env, "/admin/apps/{appId}", app, app.getAppId());
    }

    public void deleteApp(Env env, String appId, String operator) {
      restTemplate.delete(env, "/admin/apps/{appId}?operator={operator}", appId, operator);
    }
  }
  ...
  public static class NamespaceAPI extends API {
    ...
    public List<NamespaceDTO> findNamespaceByCluster(String appId, Env env, String clusterName) {
      NamespaceDTO[] namespaceDTOs = restTemplate.get(env, "/admin/apps/{appId}/clusters/{clusterName}/namespaces",
    ...
    public NamespaceDTO loadNamespace(String appId, Env env, String clusterName,
      ...
      return
          restTemplate.get(env, "/admin/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}",
    ...
    public NamespaceDTO findPublicNamespaceForAssociatedNamespace(Env env, String appId, String clusterName,
      ...
      return
          restTemplate
              .get(env, "/admin/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/associated-public-namespace",
                  NamespaceDTO.class, appId, clusterName, namespaceName);
    }

    public NamespaceDTO createNamespace(Env env, NamespaceDTO namespace) {
      return restTemplate
          .post(env, "/admin/apps/{appId}/clusters/{clusterName}/namespaces", namespace, NamespaceDTO.class,
    ...
    public AppNamespaceDTO createAppNamespace(Env env, AppNamespaceDTO appNamespace) {
      return restTemplate
          .post(env, "/admin/apps/{appId}/appnamespaces", appNamespace, AppNamespaceDTO.class, appNamespace.getAppId());
    }

    public AppNamespaceDTO createMissingAppNamespace(Env env, AppNamespaceDTO appNamespace) {
      return restTemplate
          .post(env, "/admin/apps/{appId}/appnamespaces?silentCreation=true", appNamespace, AppNamespaceDTO.class,
              appNamespace.getAppId());
    }

    public List<AppNamespaceDTO> getAppNamespaces(String appId, Env env) {
      AppNamespaceDTO[] appNamespaceDTOs = restTemplate.get(env, "/admin/apps/{appId}/appnamespaces", AppNamespaceDTO[].class, appId);
    ...
    public void deleteNamespace(Env env, String appId, String clusterName, String namespaceName, String operator) {
      restTemplate
          .delete(env, "/admin/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}?operator={operator}", appId,
              clusterName,
              namespaceName, operator);
    }

    public Map<String, Boolean> getNamespacePublishInfo(Env env, String appId) {
      return restTemplate.get(env, "/admin/apps/{appId}/namespaces/publish_info", typeReference, appId).getBody();
    }

    public List<NamespaceDTO> getPublicAppNamespaceAllNamespaces(Env env, String publicNamespaceName,
        int page, int size) {
      NamespaceDTO[] namespaceDTOs =
          restTemplate.get(env, "/admin/appnamespaces/{publicNamespaceName}/namespaces?page={page}&size={size}",
    ...
    public int countPublicAppNamespaceAssociatedNamespaces(Env env, String publicNamesapceName) {
      Integer count =
          restTemplate.get(env, "/admin/appnamespaces/{publicNamespaceName}/associated-namespaces/count", Integer.class,
              publicNamesapceName);
    ...
    public void deleteAppNamespace(Env env, String appId, String namespaceName, String operator) {
      restTemplate.delete(env, "/admin/apps/{appId}/appnamespaces/{namespaceName}?operator={operator}", appId, namespaceName,
          operator);
    }
  }
