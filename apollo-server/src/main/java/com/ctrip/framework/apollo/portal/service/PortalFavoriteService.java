...
import com.ctrip.framework.apollo.portal.repository.PortalFavoriteRepository;
...
@Service
public class PortalFavoriteService {
  ...
  public PortalFavoriteService(
      final UserInfoHolder userInfoHolder,
      final PortalFavoriteRepository favoriteRepository,
  ...
  public PortalFavorite addFavorite(PortalFavorite favorite) {
    ...
    PortalFavorite checkedFavorite = favoriteRepository.findByUserIdAndAppId(loginUser.getUserId(), favorite.getAppId());
  ...
  public List<PortalFavorite> search(String userId, String appId, Pageable page) {
  ...
  public void deleteFavorite(long favoriteId) {
    PortalFavorite favorite = favoriteRepository.findById(favoriteId).orElse(null);
  ...
  public void adjustFavoriteToFirst(long favoriteId) {
    ...
    PortalFavorite firstFavorite = favoriteRepository.findFirstByUserIdOrderByPositionAscDataChangeCreatedTimeAsc(userId);
  ...
  private void checkUserOperatePermission(PortalFavorite favorite) {
    if (favorite == null) {
