...
public class PermissionController {
  ...
  private final PortalSystemRoleManagerService systemRoleManagerService;
  ...
  public PermissionController(
          ...
          final PortalSystemRoleManagerService systemRoleManagerService,
  ...
  public ResponseEntity<Void> addCreateApplicationRoleToUser(@RequestBody List<String> userIds) {
    ...
    rolePermissionService.assignRoleToUsers(PortalSystemRoleManagerService.CREATE_APPLICATION_ROLE_NAME,
  ...
  public ResponseEntity<Void> deleteCreateApplicationRoleFromUser(@PathVariable("userId") String userId) {
    ...
    userIds.add(userId);
    rolePermissionService.removeRoleFromUsers(PortalSystemRoleManagerService.CREATE_APPLICATION_ROLE_NAME,
  ...
  public List<String> getCreateApplicationRoleUsers() {
    return rolePermissionService.queryUsersWithRole(PortalSystemRoleManagerService.CREATE_APPLICATION_ROLE_NAME)
