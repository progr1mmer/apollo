...
@Service
public class PortalReleaseHistoryService {
  ...
  public PortalReleaseHistoryService(final AdminServiceAPI.ReleaseHistoryAPI releaseHistoryAPI, final PortalReleaseService releaseService) {
