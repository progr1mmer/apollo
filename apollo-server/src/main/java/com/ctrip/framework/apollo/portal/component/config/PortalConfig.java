...
public class PortalConfig extends RefreshableConfig {
  ...
  public boolean isCreateApplicationPermissionEnabled() {
    return getBooleanProperty(PortalSystemRoleManagerService.CREATE_APPLICATION_LIMIT_SWITCH_KEY, false);
  }

  public boolean isManageAppMasterPermissionEnabled() {
    return getBooleanProperty(PortalSystemRoleManagerService.MANAGE_APP_MASTER_LIMIT_SWITCH_KEY, false);
  }
