...
import com.ctrip.framework.apollo.portal.service.PortalItemService;
...
public class ItemController {
  ...
  private final PortalItemService configService;
  private final PortalNamespaceService namespaceService;
  private final UserInfoHolder userInfoHolder;
  private final PermissionValidator permissionValidator;

  public ItemController(final PortalItemService configService, final UserInfoHolder userInfoHolder,
                        final PermissionValidator permissionValidator, final PortalNamespaceService namespaceService) {
