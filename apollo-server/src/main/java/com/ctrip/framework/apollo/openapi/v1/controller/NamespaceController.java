...
import com.ctrip.framework.apollo.portal.service.PortalNamespaceLockService;
...
public class NamespaceController {
  ...
  private final PortalNamespaceLockService namespaceLockService;
  ...
  public NamespaceController(
      final PortalNamespaceLockService namespaceLockService,
  ...
  public OpenAppNamespaceDTO createNamespace(@PathVariable String appId,
    ...
    PortalAppNamespace appNamespace = OpenApiBeanUtils.transformToAppNamespace(appNamespaceDTO);
    PortalAppNamespace createdAppNamespace = appNamespaceService.createAppNamespaceInLocal(appNamespace, appNamespaceDTO.isAppendNamespacePrefix());
