...
public class PortalNamespaceService {
  ...
  private final PortalReleaseService releaseService;
  private final PortalAppNamespaceService appNamespaceService;
  private final PortalInstanceService instanceService;
  private final PortalNamespaceBranchService branchService;
  private final PortalRolePermissionService rolePermissionService;

  public PortalNamespaceService(
      final PortalConfig portalConfig,
      final PortalSettings portalSettings,
      final UserInfoHolder userInfoHolder,
      final AdminServiceAPI.NamespaceAPI namespaceAPI,
      final PortalItemService itemService,
      final PortalReleaseService releaseService,
      final PortalAppNamespaceService appNamespaceService,
      final PortalInstanceService instanceService,
      final @Lazy PortalNamespaceBranchService branchService,
  ...
  private void fillAppNamespaceProperties(NamespaceBO namespace) {
    ...
    PortalAppNamespace appNamespace =
        appNamespaceService
