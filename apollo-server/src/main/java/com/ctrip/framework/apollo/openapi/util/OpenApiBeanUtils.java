...
public class OpenApiBeanUtils {
  ...
  public static OpenAppNamespaceDTO transformToOpenAppNamespaceDTO(PortalAppNamespace appNamespace) {
    Preconditions.checkArgument(appNamespace != null);
    return BeanUtils.transform(OpenAppNamespaceDTO.class, appNamespace);
  }

  public static PortalAppNamespace transformToAppNamespace(OpenAppNamespaceDTO openAppNamespaceDTO) {
    Preconditions.checkArgument(openAppNamespaceDTO != null);
    return BeanUtils.transform(PortalAppNamespace.class, openAppNamespaceDTO);
  }
  ...
  public static List<OpenAppDTO> transformFromApps(final List<PortalApp> apps) {
  ...
  public static OpenAppDTO transformFromApp(final PortalApp app) {
