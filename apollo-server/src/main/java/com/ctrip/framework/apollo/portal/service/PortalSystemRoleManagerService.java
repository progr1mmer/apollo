...
@Service
public class PortalSystemRoleManagerService {
  public static final Logger logger = LoggerFactory.getLogger(PortalSystemRoleManagerService.class);
  ...
  @Autowired
  public PortalSystemRoleManagerService(final PortalRolePermissionService rolePermissionService,
